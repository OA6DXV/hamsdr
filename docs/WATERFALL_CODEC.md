...
| 1 | profile | 1 mobile, 2 balanced, 3 raw |
...
frequency window. Reduced profiles max-pool adjacent bins,
then quantize and pack fixed-width integers. Max-pooling was selected to keep
