/* @ts-self-types="./hamsdr_mfsk_decoder.d.ts" */
 ...
 * @returns {Array<any>}
 */
export function decode_slot(mode, pcm, timestamp_us) {
    const ptr0 = passStringToWasm0(mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_slot(ptr0, len0, pcm, timestamp_us);
    return ret;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./hamsdr_mfsk_decoder_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hamsdr_mfsk_decoder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
